    ...
    <div>
      ...
      <SectionTwo image={Imagen2} >
        ...
        <ul className="list-none space-y-2 text-base md:text-lg">
          ...
          <li className="before:content-['+'] before:mr-2 before:font-bold">Cálculos de impuestos (ISR, IVA y otros)</li>
          <li className="before:content-['+'] before:mr-2 before:font-bold"><b>Declaraciones</b> de impuestos mensuales</li>
          <li className="before:content-['+'] before:mr-2 before:font-bold">Solicitud de devoluciones de IVA y atención a requerimientos</li>
          <li className="before:content-['+'] before:mr-2 before:font-bold"><b>Recuperación de impuestos</b> federales</li>
          <li className="before:content-['+'] before:mr-2 before:font-bold"><b>Planeación fiscal</b> para personas físicas y morales</li>
          <li className="before:content-['+'] before:mr-2 before:font-bold">Diagnósticos para efectos de compra o venta de empresas</li>
          <li className="before:content-['+'] before:mr-2 before:font-bold">Elaboración de <b>dictamen fiscal</b></li>
        </ul>
        <Contactar />
      </SectionTwo>

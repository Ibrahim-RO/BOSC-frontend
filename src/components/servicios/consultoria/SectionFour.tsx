            ...
            <div className='flex flex-col md:flex-row items-stretch w-full'>
                ...
                <div className='w-full md:w-4/7 flex items-center justify-center py-8 md:py-0 px-4 md:px-6 lg:px-8'>
                    <div className='text-center md:text-left space-y-4 md:space-y-6 max-w-md'>
                        <h2 className='font-title text-xl md:text-2xl lg:text-3xl xl:text-4xl font-bold text-title leading-tight'>
                        ...
                        <button className="font-title text-sm md:text-base px-4 py-2 rounded-full uppercase hover:bg-cafeBosc hover:text-white bg-title font-semibold transition-colors cursor-pointer hover:scale-110 hover:transition-transform hover:duration-300">
                            Quiero conocer
                        </button>
                    </div>
                </div>
